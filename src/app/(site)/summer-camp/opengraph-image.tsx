...
export const alt =
  "Moyours Football Summer Camp  27 July to 28 August, ages 2–17, Wuse Zone 2 Abuja";
  ...
  return new ImageResponse(
    ...
    >
      ...
      >
        ...
        >
          <div style={{ fontSize: 44, fontWeight: 800, color: "#14140F" }}>
            #120,000
          </div>
          <div style={{ fontSize: 22, fontWeight: 600, color: "#14140F" }}>
            5 WEEKS · REGISTER NOW
          </div>
        </div>
      </div>
    </div>,
