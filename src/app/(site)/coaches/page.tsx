...
export const metadata: Metadata = {
  title: "Coaches",
  description: "Meet the Moyours Football Club Academy coaching team.",
};
  ...
  return (
    <div className="mx-auto max-w-5xl px-[var(--gutter)] py-12">
      ...
      <p className="mt-3 max-w-2xl text-step-0 text-kit-soft">
        Qualified, safeguarding-trained, and above all invested in each child.
        These are the people on the touchline every Friday and Saturday.
      </p>
          ...
          {coaches.map((coach) => (
            ...
            >
              <div className="flex items-center gap-4">
                ...
                {coach.ageGroup && (
                  <span className="font-mono text-step-2 font-bold text-pitch">
                    {coach.ageGroup}
                  </span>
                )}
              </div>
