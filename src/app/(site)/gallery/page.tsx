...
export const metadata: Metadata = {
  title: "Gallery",
  description:
    "Photos from Moyours Football Club Academy training, matches, and camps.",
};
        ...
        <div className="mt-10 grid grid-cols-2 gap-4 md:grid-cols-3">
          {albums.map((album) => (
            ...
            >
                ...
                <Image
                  src={
                    album.coverUrl.includes("res.cloudinary.com")
                      ? album.coverUrl.replace(
                          "/upload/",
                          "/upload/f_auto,q_auto,w_600,h_400,c_fill/",
                        )
                      : album.coverUrl
                  }
                  alt=""
              ...
              <div className="p-4">
                <h2 className="font-display text-step-0 group-hover:underline">
                  {album.title}
                </h2>
                <p className="text-step--1 text-kit-soft">
                  {album._count.assets} photos
                </p>
              </div>
            </Link>
          ))}
