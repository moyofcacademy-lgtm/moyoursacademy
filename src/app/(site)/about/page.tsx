    ...
    <>
      ...
      <section className="relative isolate overflow-hidden bg-pitch text-chalk">
        ...
        <div className="mx-auto max-w-4xl px-[var(--gutter)] py-16 sm:py-20">
          ...
          <h1 className="mt-2 font-display text-step-3 sm:text-step-4">
            Raising Champions.
          </h1>
          <p className="rule-gold mt-6 max-w-xl pt-4 text-step-1 text-chalk-dim">
            Our vision:{" "}
            <span className="text-chalk">a society healed by sports.</span>
          </p>
      ...
      <section
        ...
        className="reveal mx-auto max-w-4xl px-[var(--gutter)] py-16"
      >
        ...
        <div className="mt-6 max-w-2xl space-y-4 text-step-0 leading-relaxed">
          <p>
            Moyours began when Coach Moyiwa helped a student who was struggling
            to join his school&apos;s football team. That single gesture grew
            into what is now a FIFA- and NFF-registered academy in Abuja.
          </p>
          <p>
            ...
            academy has persevered and today develops athletes competing at
        ...
        <div className="mx-auto grid max-w-4xl gap-8 px-[var(--gutter)] py-16 md:grid-cols-2">
          ...
          <div className="space-y-4 text-step-0 leading-relaxed">
            <p>
              ...
              training and limited exposure opportunities. Moyours closes that
              gap with expert instruction, organized development programs, and
              worldwide partnerships that enable emerging talents to achieve
              their aspirations.
            </p>
            <p className="font-display text-step-1 text-pitch">
              We are a family, a pathway, and a beacon of hope for young
              Nigerians pursuing professional football.
            </p>
          </div>
        </div>
      </section>
        ...
        <dl className="mt-8 grid grid-cols-2 gap-x-6 gap-y-8">
          {site.stats.map((stat) => (
            <div key={stat.label} className="rule-gold pt-4">
              <dd className="tabular font-mono text-step-3 font-bold text-pitch">
                {stat.value}
              </dd>
              <dt className="mt-1 text-step--1 leading-relaxed text-kit-soft">
                {stat.label}
              </dt>
            </div>
          ))}
